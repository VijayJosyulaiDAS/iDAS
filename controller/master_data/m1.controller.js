...
let getM1Data = async (req, res) => {
    try {
        const query = `SELECT [Reporting Country] as reporting_country, [Category] as category, [Brand] as brand,  [Customer Group] as customer_group, [SFU Version] as sfu_version, [APO Product] as apo_product, [Product Description] as product_description, 
