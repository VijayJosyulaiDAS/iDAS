...
export type PingAuth<User, SignInPayload, SignUpPayload> = {
	user: User;
...
const usePingAuth = <User, SignInPayload, SignUpPayload>(
	props: PingAuthProps<User>
): PingAuth<User, SignInPayload, SignUpPayload> => {
	...
	const authConfig = _.defaults(config, backendAuthURI);
