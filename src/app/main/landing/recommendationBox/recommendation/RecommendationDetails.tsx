				...
				<Paper className="flex flex-col flex-0 w-full shadow rounded-2xl overflow-hidden">
					<div className="flex flex-col py-32 px-24">
						<div className="flex items-center w-full">
							<FuseSvgIcon size={48} color="action">heroicons-solid:user-circle</FuseSvgIcon>
					...
					<Box
						...
						sx={{ backgroundColor: 'background.default' }}
					>
						<div className="flex flex-wrap w-full -m-8 justify-end items-end">
							<Button
								className="m-8"
								color="secondary"
								to="/example"
								component={Link}
								startIcon={<FuseSvgIcon size={20}>material-twotone:details</FuseSvgIcon>}
								variant="outlined"
							>
								More Details
							</Button>
...
export default withRouter(RecommendationDetails);
