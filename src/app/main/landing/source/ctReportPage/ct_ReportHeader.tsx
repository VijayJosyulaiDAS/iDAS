...
function Ct_ReportHeader({onUpload, jsonData}) {
    ...
    const handleUpload = async () => {
        ...
        try {
            setLoading(true)
            await axios.post(`${import.meta.env.VITE_LOCAL_BASE_URL}/create_upcoming_production`, formData, {}).then((response) => {
                setUpdated(!updated)
...
export default Ct_ReportHeader;